Abbiamo già visto come [[Secondo anno/Programmazione ad oggetti/Mod. 2/Thread|creare thread in Java]], e abbiamo visto come la keyword `synchronized` permetta:
